...
const searchDrinkResultsContainer =
  document.getElementById("drinkSearchResults");
...
function advSearchFunction(data) {
  ...
  if (maxPrepTime === NaN) {
    window.alert =
      "Max Prep Time can only accept numbers. Please input the max prep time desired in minutes only.";
  }
